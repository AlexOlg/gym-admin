      ...
      <div className="w-96  bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
        <div className="p-6 space-y-2 md:space-y-3 ">
          ...
          <form className="space-y-4 md:space-y-6" action="#">
            ...
            <button
              type="submit"
              className="w-full text-white bg-blue-900 hover:bg-blue-800 hover:duration-150  font-medium rounded-lg text-sm px-5 py-2.5 text-center  "
            >
              Create an account
            </button>
